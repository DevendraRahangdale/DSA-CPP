...
void convertBSTintoDoublylinkedlist(Node*root,Node *&head){
	if(root==NULL){
		return ;
	}
	//RNL
	// R
	convertBSTintoDoublylinkedlist(root->right,head);
...
convertBSTintoDoublylinkedlist(root->left,head);
...
void printlinkedlist(Node* head){
	Node*temp=head;
	cout<<"print the entire linked list"<<endl;
	while(temp != NULL){
		cout<<temp->data<<"->";
		temp=temp->right;
	}
...
Node*head=NULL;
convertBSTintoDoublylinkedlist(root,head);
